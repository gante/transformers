...
from ..modeling_attn_mask_utils import _prepare_4d_causal_attention_mask_with_cache_position
...
class GenerationMixin:
    ...
    def prepare_inputs_for_generation(
        ...
        """
        Prepares model inputs for generation. This function is originally designed for LLMs, and should be overridden
        in the model if the model needs to pipeline inputs differently for generation.
        """
